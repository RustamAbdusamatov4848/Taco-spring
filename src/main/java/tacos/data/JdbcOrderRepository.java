...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order) {
        ...
        //Since you will need the saved order ID later, you need to call this method on the pscf object
        pscf.setReturnGeneratedKeys(true);

        //Set the time when the order was created
    ...
    private List<IngredientRef> findIngredientsByTacoId(long tacoId) {
        return jdbcOperations.query("select ingredient from Ingredient_Ref "
